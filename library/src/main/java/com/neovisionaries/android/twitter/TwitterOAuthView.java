...
public class TwitterOAuthView extends WebView
{
    ...
    public interface Listener
    {
        ...
        /**
         * Called when the OAuth page load finished.
         *
         * @param view
         * @param url
         */
        void onPageFinished(TwitterOAuthView view, String url);
    }
...
//                    mSearchActivity.onBackPressed();
    ...
    private class TwitterOAuthTask extends AsyncTask<Object, Void, Result>
    {
        ...
        protected Result doInBackground(Object... args)
        {
            ...
            if (dummyCallbackUrl) {
                requestToken = getRequestToken(callbackUrl);
            }
            else {
                requestToken = getRequestToken(null);
            }
        ...
        private class LocalWebViewClient extends WebViewClient
        {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (listener != null) listener.onPageFinished(TwitterOAuthView.this, url);
            }
